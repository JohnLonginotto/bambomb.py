...
if args.test_six: read = '(\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
# picard compatible read (valid BAM):
else:             read = '(\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x49\x12\x01\x00\x81\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00'
read = list(read)
